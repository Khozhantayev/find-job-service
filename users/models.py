...
class Message(models.Model):
    ...
    email = models.EmailField(max_length=200, null=True, blank=True,  verbose_name="Your e-mail")
    subject = models.CharField(max_length=200, null=True, blank=True,  verbose_name="Message subject")
